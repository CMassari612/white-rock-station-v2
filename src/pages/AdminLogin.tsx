...
import { WrsLogo } from '../components/WrsLogo';
  ...
  return (
    <div className="wrs" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ background: 'var(--wrs-green)', borderRadius: 16, padding: '20px 20px 8px', textAlign: 'center', marginBottom: 16 }}>
          <WrsLogo height={64} color="#f4efe3" />
        </div>
